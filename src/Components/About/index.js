...
import img3 from '../../assets/images/ourteam1.png';
import img4 from '../../assets/images/ourteam2.jpg';
import img5 from '../../assets/images/ourteam3.png';
import img6 from '../../assets/images/ourteam4.png';
import img7 from '../../assets/images/nuts.jpg';
import img8 from '../../assets/images/ellipse.png';
import img9 from '../../assets/images/mission.png';
import img10 from '../../assets/images/vision.png';
import img11 from '../../assets/images/do.png';
import img01 from '../../assets/images/colab.png';
import img02 from '../../assets/images/colab1.png';
import img03 from '../../assets/images/colab2.png';
import img04 from '../../assets/images/achive.png';
import img05 from '../../assets/images/achive1.png';
import img06 from '../../assets/images/achive2.png';
import img07 from '../../assets/images/nuts1.png';

import './AboutStyles.css';

function AboutUsView({ about, ...props }) {
  return (
    <>
      {/* section1 starts */}
      <div className='about_sec1'>
        ...
        <div className='about_section2__item--1'>
          <h4 className='w3-center about_sec2_h4'>{about.pageTitle}</h4>
          <h9 className='w3-center'>{about.pageSubTitle}</h9>
          <span>
            <FaQuoteLeft />
          </span>
          <h6>{about.tagLine}</h6>
      ...
      <div className='about_sec3_sec'>
        <div className='about_sec3_container'>
          <div className='about_sec3_header'>
            <h2>{about.storySection.sectionPrimaryTitle}</h2>
          </div>
          {/* BigScreen */}
          ...
          <div className='about_sec3_div_container'>
            ...
            <div className='about_div2'>
              <h2>{about.storySection.sectionSecondaryTitle}</h2>
              <h3>{about.storySection.sectionDescription}</h3>
              ...
              <div className='ourteam_names_socials'>
                ...
                <a href='rrr' class='instagram'>
                  ...
                  <FontAwesomeIcon
                    ...
                    style={{ color: '#E1206C', fontSize: '20px' }}
                  />
                </a>
      ...
      <div className='about-sec6'>
        <div className='w3-card-4 about_sec6__card1'>
          <div className='about_sec6__card1--1'>
            ...
            <div className='w3-center card1_item_2'>
              <img src={img9} alt='s' style={{ height: '80px' }} />
            </div>
          </div>
        ...
        <div className='w3-card-4 about_sec6__card2'>
          <div className='about_sec6__card1--1'>
            ...
            <div className='w3-center card1_item_2'>
              <img src={img10} alt='s' style={{ height: '80px' }} />
            </div>
          </div>
          <div className='about_sec6__card1--2'>
            <ul>
